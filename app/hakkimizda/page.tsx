        ...
        <div className={styles.container}>
          ...
          <div className={styles.description}>
            <div className={styles.leftContent}>
              <p>AKBAT CONSTRUCTION olarak, inşaat sektöründe 1998'den bu yana sunduğumuz hizmetlerle köklü bir geçmişe sahibiz. Kurucumuz Yusuf Aktaş'ın nesiller boyunca süregelen tecrübeleri ve inşaata dair derin bilgi birikimi, Vannes ve çevresinde yüzlerce projede kendini göstermiştir. Bu birikimi daha ileri taşımak ve geleceğin yapılarını şekillendirmek adına, kaliteli, güvenilir ve yenilikçi çözümler sunmaya devam ediyoruz.</p>
            </div>
