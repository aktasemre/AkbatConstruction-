    ...
    <div className={styles.servicePage}>
      ...
      <section className={styles.hero}>
        <div className={styles.container}>
          ...
          <p>ESİ YAPI, BİNALARINIZIN DIŞ CEPHESİNİ HEM ESTETİK HEM DE DAYANIKLILIK ESASLARINA GÖRE YENİLER. DIŞ CEPHE MANTOLAMA, SIVA, MONTAJ VE ISI YALITIMINDA UZMAN ÇÖZÜMLER SUNARAK BİNALARINIZI DIŞ ETKENLERE KARŞI KORUYOR VE MODERN BİR GÖRÜNÜM KAZANDIRIYORUZ.</p>
        </div>
      </section>
